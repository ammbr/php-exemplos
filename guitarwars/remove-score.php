...
if(isset($_POST['submit'])) {
	...
	echo '<form method="post" action="remove-score.php">';
...
echo '<p><a href="admin.php">&lt;&lt;Voltar para a página admin</a></p>';
